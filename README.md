...
*   **자기장 관리:**
    ...
    *   자기장 축소 중 보스 바에 자기장 정보(중심까지의 거리, 크기, 방향)가 표시됩니다.
...
*   **아이템 드롭 및 블록 파괴:**
    *   **광물 드롭:**
        ...
        *   심층암 에메랄드 광석: 에메랄드 (1개)
        *   심층암 석탄 광석: 석탄 (1개)
    *   **모래 블록 파괴:** 모래 블록 파괴 시 20% 확률로 자수정 조각이 드롭됩니다.
    *   **유리 블록 파괴:** 유리 또는 유리판 파괴 시 20% 확률로 자수정 조각이 드롭됩니다.
...
**참고:** `/총`, `/chd`, `/빵`, `/기본템`, `/rlqhsxpa`, `/밥`, `/top`, `/탑`을 제외한 대부분의 명령어는 OP(운영자)만 사용할 수 있습니다.
